...
pub mod prelude {
    pub use crate::{components::*, routes::*, services::*, types::*};
}
...
//                         <h1 class="font-bold text-2xl text-white">{"Trunk | Yew |
// Tailwind"}</h1>                         <div class="flex-1"></div>
//                         {for links.iter().map(|(label, href)| html! {
//                             <a class={link_classes} href={*href}>{label}</a>
//                         })}
//                     </div>
//                 </nav>
//                 <div class="bg-gray-50 flex-1 flex py-16 px-8 items-center gap-6
// justify-center">                     {view_card("Trunk", None, html! {
//                         <p>{"Trunk is a WASM web application bundler for Rust."}</p>
//                     })}
//                     {view_card("Yew", Some("yew.svg"), html! {
//                         <p>{"Yew is a modern Rust framework for creating multi-threaded
// front-end web apps with WebAssembly."}</p>                     })}
//                     {view_card("Tailwind CSS", None, html! {
//                         <p>{"Tailwind CSS is a library for styling markup using a
// comprehensive set of utility classes, no CSS required."}</p>                     })}
//                 </div>
//             </div>
//         }
//     }
